    ...
    <main className="login">
      ...
      <section className="login-form">
        <form onSubmit={event => { event.preventDefault(); void submit(); }}>
          ...
          {connection === 'other-tab-active' && <p className="fine">Fermez l’autre onglet ApisnixPhone, puis reconnectez-vous ici. Si vous venez de vous déconnecter dans cet onglet, actualisez la page avant de réessayer.</p>}
